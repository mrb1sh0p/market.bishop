...
export function down(knex) {
  return knex.raw(
    `
      ...
      DROP TABLE store_shipment_options;
      DROP TABLE store_payment_gateway;
      DROP TABLE user_in_store;
      DROP TABLE stores;
      DROP TABLE users;

      DROP TYPE payment_status;
      DROP TYPE order_status;
      DROP TYPE product_media_status;
      DROP TYPE product_media_type;
      DROP TYPE product_type;
      DROP TYPE shipment_option;
      DROP TYPE payment_gateway;
      DROP TYPE user_in_store_role;
      DROP TYPE user_role;
    `
  );
}
