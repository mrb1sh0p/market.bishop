...
CREATE TYPE order_status AS ENUM ('paid', 'waiting', 'canceled', 'refunded', 'chargeback', 'missed-delivery', 'working', 'shipped', 'delivered', 'done');
CREATE TYPE payment_status AS ENUM ('paid', 'waiting', 'canceled', 'refunded', 'chargeback', 'release');
